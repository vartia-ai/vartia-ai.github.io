...
![Illustration of a glowing cube in a grid](thumbnail.png){.article-hero}
...
This confusion matrix is a comparison of the dataset label and the LLM predicted lable. Correct predictions are found on the diagonal. 
All of the non-diagonal cells show a count of that type of misprediction.
...
[← Article 2: When are 2 bugs the same bug](../oob_bench2/)